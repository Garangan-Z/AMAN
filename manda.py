...
def banner():
    print("\n%s    __  ____ _____  __**********___ _____     \n%s   /  \/   /__    )/  )__  ____/  /__    )  ║ %sR %s& %sA\n%s  /       /___)   /  __  )/  __  /___)   / ║ %sFb %s: %sRaka\n%s /  /\/  /  __   /  / / /   (_/ /  __   / ║ %sIg %s: %sraka27\n%s/__/  /_/(______/__/ /_/(______/(______/  ║ %sGt %s: %sBangsat-XD\n"%(O,O,O,P,O,O,P,O,P,O,P,O,P,O,P,O,P))
def menu_log():
